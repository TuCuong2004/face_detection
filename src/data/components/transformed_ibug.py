...
from src.data.components.augmentors.modern_posit import PositPose
from src.data.components.augmentors.heatmaps import Heatmaps
from src.data.components.augmentors.boundary import AddBoundary
from src.data.components.augmentors.landmarks import HorizontalFlipAug, RSTAug, OcclusionAug, \
